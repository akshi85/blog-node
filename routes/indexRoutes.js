...
const { loginPage, registerPage, dashboardPage, registerrecord, loginrecord, logout, travel, eat, clothes, add, addRecord, view, deleteData, editData, updateRecord } = require('../controller/AuthController');
