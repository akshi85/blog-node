...
const updateRecord = async(req,res) => {
    try{
        const {editid,title,content,date} = req.body;
        if(req.file){
...
module.exports = {
    registerPage ,loginPage , dashboardPage , registerrecord , loginrecord , logout , travel , eat , clothes , add , addRecord , view , deleteData , editData , updateRecord
}
